...
Purpose:
    This script facilitates the packaging of the backend system. 
...
REPO_NAME = "career_chief_rep"
AUTHOR_USER_NAME = "etietopabraham"
SRC_REPO = "career_chief"
...
setup(
    ...
    description="Transformer based endpoint for matching resumes with job descriptions.",
